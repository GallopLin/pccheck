...
class BloomTerminal(nn.Module):
    ...
    def __init__(self, config, is_first=True, res=None, ind=0):
    ...
    def forward_last(self, inputs):
        ...
        print(f'lm_output is {lm_output}')
        return lm_output
...
def get_bloom_causal_lm_specs(config, res={}, grad_ckpt=False,
